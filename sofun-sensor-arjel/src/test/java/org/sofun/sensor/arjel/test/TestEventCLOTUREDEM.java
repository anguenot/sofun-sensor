...
/**
 * Test event CLOTUREDEM XML generation.
 * 
 * @author <a href="mailto:julien@anguenot.org">Julien Anguenot</a>
 * 
 */
public class TestEventCLOTUREDEM extends AbstractARJELTestCase {
    ...
    public void testValidEvent() throws Exception {
        ...
        final String fieldSoldeClos = "30.24";

        EventCLOTUREDEM trace = new EventCLOTUREDEMImpl(operatorID, safeID,
        ...
        assertEquals(getXMLFrom("event/CLOTUREDEM.xml"), xml);

        xml = trace.translate();
        assertEquals(getRootXMLFrom("event/CLOTUREDEM_TR.xml"), xml);
