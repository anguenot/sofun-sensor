...
/**
 * Test event CPTEALIMOPE XML generation.
 * 
 * @author <a href="mailto:julien@anguenot.org">Julien Anguenot</a>
 * 
 */
public class TestEventCPTEALIMOPE extends AbstractARJELTestCase {
    ...
    public void testValidEvent() throws Exception {
        ...
        final String fieldBonusAvant = "100";

        final String fieldBonusApres = "110";

        final String fieldBonusMouvement = "10";

        final String fieldBonusNom = "Welcome Bonus";

        XMLTrace trace = new EventCPTEALIMOPEImpl(operatorID, safeID, eventId,
                eventDate, playerID, playerIP, sessionID, fieldTypAg,
                fieldBonusAvant, fieldBonusApres, fieldBonusMouvement,
                fieldBonusNom);

        trace.validate();

        String xml = trace.getXML();
        assertEquals(getXMLFrom("event/CPTEALIMOPE.xml"), xml);

        xml = trace.translate();
        assertEquals(getRootXMLFrom("event/CPTEALIMOPE_TR.xml"), xml);
