...
/**
 * Test event OUVINFOPERSO XML generation.
 * 
 * @author <a href="mailto:julien@anguenot.org">Julien Anguenot</a>
 * 
 */
public class TestEventOUVINFOPERSO extends AbstractARJELTestCase {
    ...
    public void testValidEvent() throws Exception {
        ...
        final String fieldLogin = "julien@anguenot.org";
        ...
        final String fieldDateN = "19810408";

        final String fieldVilleN = "Besançon";

        final String fieldDptN = "25";

        final String fieldPaysN = "France";
        ...
        EventOUVINFOPERSO trace = new EventOUVINFOPERSOImpl(operatorID, safeID,
                eventID, eventDate, playerID, playerIP, sessionID, fieldTypAg,
                fieldLogin, fieldPseudo, fieldNom, fieldPrenoms, fieldCivilite,
                fieldDateN, fieldVilleN, fieldDptN, fieldPaysN, fieldAd,
                fieldCP, fieldVille, fieldPays, fieldTelFixe, fieldTelMob,
                fieldEmail);

        trace.validate();

        String xml = trace.getXML();
        assertEquals(getXMLFrom("event/OUVINFOPERSO.xml"), xml);

        xml = trace.translate();
        assertEquals(getRootXMLFrom("event/OUVINFOPERSO_TR.xml"), xml);
